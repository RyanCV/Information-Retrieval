...
<div id="nav">
<ul>
<li><a>Search Engine 1</a></li>
<li><a href="search2.php">Search Engine 2</a></li>
<li><a href="search3.php">Search Engine 3</a></li>
</ul>
</div>
...
<fieldset>
<legend>Search Engine 1: Basic</legend>
...
<?php
    ...
    $indice = ppython("togetherIndiceResult::together_indice_result", $searchKeyword,$pageno);
    ...
    <table id = "t01" border=1 frame=void rules=rows>
        ...
        <?php
            foreach($indice as $value){
                ...
                echo "<a href=\"$value[0]\" target=\"_blank\" display=\"block\" height=50px>$value[0]</a>";
                echo '</td>';
				//echo '<td>Relavent<br>';
